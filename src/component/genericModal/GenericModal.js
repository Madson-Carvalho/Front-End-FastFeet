...
const GenericModal = () => {
    return (
        <div className="container">
            <details>
                <summary>
                    <div className="button">Show me the modal</div>
                ...
                <div className="details-modal">
                    ...
                    <div className="details-modal-content">
                        <p>
                            ...
                            additional information, but that's about as far as I would take it.
                            It's just a nice way of styling the details element.
                        </p>
                    </div>
                </div>
            </details>
